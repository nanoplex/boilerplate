...
<head runat="server">
    ...
    <style>
        ...
        body {
            ...
            border-radius: 4px;
            margin: 0 auto;
            box-shadow: 0 2px 5px 0 rgba(0,0,0,.26),0 2px 10px 0 rgba(0,0,0,.16), inset 0 1px 0 #fff;
            background: #fcfcfc;
        }
...
<body>
    <form id="form1" runat="server">
        <div class="container">
            <h1>Findes ikke <span>:(</span></h1>
            <p>Desværre, men siden du prøver at kunne ikke vises</p>
            <p>Det ser ud til at du har skrevet adressen forkert, eller er siden blevet fjernet</p>
